import { FACEBOOK_LINK, INSTRAGRAM_LINK, TWITTER_LINK } from "../../../../config/config.service.js";
...
export const emailTemplate = ({ code, title } = {}) => {
    return `<!DOCTYPE html>
                ...
                <a href="${INSTRAGRAM_LINK}" style="text-decoration: none;"><span class="twit" style="padding:10px 9px;color:#fff;border-radius:50%;">
